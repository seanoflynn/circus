...
// per instrument.
//
// No book reference: Action.Symbol is which book this was, and every event carries its own
// instrument too, so a consumer keys off that the same way the dispatch loop does. Keeping the book
