...
namespace Circus.Tests.OrderBook
{
    ...
    public class InMemoryOrderBookTests
    {
        ...
        public void CreateLimitOrder_MatchAtSamePriceWithAggressorRemaining_Success()
        {
            ...
            var matched = events[1] as OrderMatched;
            ...
            Assert.AreEqual(ClientId1, matched.Resting.ClientId);
            Assert.AreEqual(OrderId1, matched.Resting.OrderId);
            ...
            Assert.AreEqual(OrderValidity.Day, matched.Resting.OrderValidity);
            ...
            Assert.AreEqual(ClientId2, matched.Aggressor.ClientId);
            Assert.AreEqual(OrderId2, matched.Aggressor.OrderId);
            ...
            Assert.AreEqual(OrderValidity.Day, matched.Aggressor.OrderValidity);
        ...
        public void CreateLimitOrder_MatchSellAgainstOrderByTime()
        {
            ...
            Assert.AreEqual(ClientId2, matched.Resting.ClientId);
            Assert.AreEqual(OrderId2, matched.Resting.OrderId);
            Assert.AreEqual(Sec, matched.Resting.Security);
            ...
            Assert.AreEqual(ClientId3, matched.Aggressor.ClientId);
            Assert.AreEqual(OrderId3, matched.Aggressor.OrderId);
            Assert.AreEqual(Sec, matched.Aggressor.Security);
        ...
        public void CreateLimitOrder_MatchSellAgainstOrdersByPrice()
        {
            ...
            var matched1 = events[1] as OrderMatched;
            ...
            Assert.AreEqual(ClientId2, matched1.Resting.ClientId);
            Assert.AreEqual(OrderId2, matched1.Resting.OrderId);
            ...
            Assert.AreEqual(OrderValidity.Day, matched1.Resting.OrderValidity);
            ...
            Assert.AreEqual(ClientId3, matched1.Aggressor.ClientId);
            Assert.AreEqual(OrderId3, matched1.Aggressor.OrderId);
            ...
            Assert.AreEqual(OrderValidity.Day, matched1.Aggressor.OrderValidity);
            ...
            var matched2 = events[2] as OrderMatched;
            ...
            Assert.AreEqual(ClientId1, matched2.Resting.ClientId);
            Assert.AreEqual(OrderId1, matched2.Resting.OrderId);
            ...
            Assert.AreEqual(OrderValidity.Day, matched2.Resting.OrderValidity);
            ...
            Assert.AreEqual(ClientId3, matched2.Aggressor.ClientId);
            Assert.AreEqual(OrderId3, matched2.Aggressor.OrderId);
            ...
            Assert.AreEqual(OrderValidity.Day, matched2.Aggressor.OrderValidity);
        ...
        public void CreateLimitOrder_MatchSellAgainstOrdersAtSamePriceByTime()
        {
            ...
            Assert.AreEqual(ClientId1, matched1.Resting.ClientId);
            Assert.AreEqual(OrderId1, matched1.Resting.OrderId);
            Assert.AreEqual(Sec, matched1.Resting.Security);
            ...
            Assert.AreEqual(ClientId2, matched2.Resting.ClientId);
            Assert.AreEqual(OrderId2, matched2.Resting.OrderId);
            Assert.AreEqual(Sec, matched2.Resting.Security);
        ...
        public void UpdateLimitOrder_MatchAgainstOrderByTime()
        {
            ...
            Assert.AreEqual(ClientId1, matched.Aggressor.ClientId);
            Assert.AreEqual(OrderId1, matched.Aggressor.OrderId);
            Assert.AreEqual(Sec, matched.Aggressor.Security);
            Assert.AreEqual(Now1, matched.Aggressor.CreatedTime);
            Assert.AreEqual(Now3, matched.Aggressor.ModifiedTime);
            Assert.AreEqual(Now3, matched.Aggressor.CompletedTime);
            Assert.AreEqual(OrderStatus.Filled, matched.Aggressor.Status);
            Assert.AreEqual(OrderType.Limit, matched.Aggressor.Type);
            Assert.AreEqual(OrderValidity.Day, matched.Aggressor.OrderValidity);
            Assert.AreEqual(Side.Sell, matched.Aggressor.Side);
            Assert.AreEqual(70, matched.Aggressor.Price);
            Assert.IsNull(matched.Aggressor.StopPrice);
            Assert.AreEqual(3, matched.Aggressor.Quantity);
            Assert.AreEqual(3, matched.Aggressor.FilledQuantity);
            Assert.AreEqual(0, matched.Aggressor.RemainingQuantity);
        ...
        public void UpdateStatus_Open_MatchPreOpenOrders()
        {
            ...
            Assert.AreEqual(Now1, matched.Resting.CreatedTime);
            Assert.AreEqual(Now1, matched.Resting.ModifiedTime);
            Assert.AreEqual(Now3, matched.Resting.CompletedTime);
            Assert.AreEqual(OrderStatus.Filled, matched.Resting.Status);
            Assert.AreEqual(OrderType.Limit, matched.Resting.Type);
            Assert.AreEqual(OrderValidity.Day, matched.Resting.OrderValidity);
            Assert.AreEqual(Side.Buy, matched.Resting.Side);
            ...
            Assert.IsNull(matched.Resting.StopPrice);
            Assert.AreEqual(5, matched.Resting.Quantity);
            Assert.AreEqual(5, matched.Resting.FilledQuantity);
            Assert.AreEqual(0, matched.Resting.RemainingQuantity);
            ...
            Assert.IsNull(matched.Aggressor.StopPrice);
            Assert.AreEqual(5, matched.Aggressor.Quantity);
            Assert.AreEqual(5, matched.Aggressor.FilledQuantity);
            Assert.AreEqual(0, matched.Aggressor.RemainingQuantity);
        }
